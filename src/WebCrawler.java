...
public class WebCrawler {
    ...
    public static void appendReport(Response resp, String url, String report, String repository, int totalOutboundLinks, int outboundLinks) {
        try {
            ...
            try (BufferedWriter out = new BufferedWriter(fw)) {
                ...
                String fileLocation = "file:///" + System.getProperty("user.dir") + "/" + repository + "/" + (id - 1) + ".html";
    ...
    public static void crawlPage(String url, int numberLinks, String domain, String repository, String report) {
        try {
            ...
            try (BufferedWriter htmlWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(f), "UTF-8"))) {
            ...
            while (!queue.isEmpty()) {
                ...
                if (visitedPages.size() >= numberLinks) return;
    ...
    public static void crawl(String fileName, String repository, String report) {
        ...
        try (Scanner scanner = new Scanner(new File(fileName))) {
            ...
            if (scanner.hasNext()) maxPages = Integer.parseInt(scanner.next());
            if (scanner.hasNext()) domain = scanner.next();
